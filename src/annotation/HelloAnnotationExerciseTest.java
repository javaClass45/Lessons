...
public class HelloAnnotationExerciseTest {
//
//    @Test
//    @Order(1)
//    @DisplayName("Annotation @Exercise exist")
//    void exerciseAnnotationExists() {
//        assertThatCode(this::getExerciseAnnotation)
...
//        var basicExerciseAnnotation = HelloAnnotationExercise.class
//                .getAnnotation(exerciseAnnotationClass);
//
...
//        return Class.forName("annotation.Exercise")
